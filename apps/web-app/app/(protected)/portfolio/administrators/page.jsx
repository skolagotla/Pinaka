...
import PortfolioAdministrators from '@/components/pages/shared/Portfolio/Administrators';

export default function PortfolioAdministratorsPage() {
  ...
  return <PortfolioAdministrators user={user} />;
}
