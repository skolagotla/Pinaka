 ...
 */
const CACHE_CONFIG = {
  '/api/properties': { ttl: 60000, enabled: true }, // 1 minute
  '/api/tenants': { ttl: 60000, enabled: true }, // 1 minute
  '/api/vendors': { ttl: 120000, enabled: true }, // 2 minutes
  '/api/reference-data': { ttl: 300000, enabled: true }, // 5 minutes
  '/api/financials/dashboard': { ttl: 30000, enabled: true }, // 30 seconds
  '/api/financials/expenses': { ttl: 60000, enabled: true }, // 1 minute
  '/api/maintenance': { ttl: 30000, enabled: true }, // 30 seconds
};
