...
import { renderStatus, renderDate, renderCurrency, renderEmail, renderPhone, renderProperty, renderTenant, renderTicketNumber, renderPriority } from '../../apps/web-app/components/shared/TableRenderers';
...
import CurrencyDisplay from '../../apps/web-app/components/rules/CurrencyDisplay';
...
export function createActionColumn(onEdit, onDelete, options = {}) {
  ...
  const { ActionButton } = require('../../apps/web-app/components/shared/buttons');
