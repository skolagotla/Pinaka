/**
 * Generated Server Stub for Invitation
 * 
...
import { 
  invitationsCreateSchema, 
  invitationsUpdateSchema, 
  ...
  try {
    switch (req.method) {
      case 'GET': {
        // List Invitations
        if (!req.query.id) {
          const query = invitationsQuerySchema.parse(req.query);
      ...
      case 'POST': {
        const data = invitationsCreateSchema.parse(req.body);
      ...
      case 'PATCH': {
        ...
        const data = invitationsUpdateSchema.parse(req.body);
