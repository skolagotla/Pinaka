...
import { 
  applicationsCreateSchema, 
  applicationsUpdateSchema, 
...
async function handler(req: NextApiRequest, res: NextApiResponse, user: UserContext) {
  ...
  try {
    switch (req.method) {
      ...
      case 'POST': {
        const data = applicationsCreateSchema.parse(req.body);
      ...
      case 'PATCH': {
        ...
        const data = applicationsUpdateSchema.parse(req.body);
