...
async function handler(req: NextApiRequest, res: NextApiResponse, user: UserContext) {
  ...
  try {
    switch (req.method) {
      ...
      case 'POST': {
        const data = tasksCreateSchema.parse(req.body);
      ...
      case 'PATCH': {
        ...
        const data = tasksUpdateSchema.parse(req.body);
