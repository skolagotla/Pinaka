/**
 * Generated Server Stub for Unit
 * 
  ...
  try {
    switch (req.method) {
      case 'GET': {
        // List Units
        if (!req.query.id) {
          const query = unitsQuerySchema.parse(req.query);
      ...
      case 'POST': {
        const data = unitsCreateSchema.parse(req.body);
      ...
      case 'PATCH': {
        ...
        const data = unitsUpdateSchema.parse(req.body);
